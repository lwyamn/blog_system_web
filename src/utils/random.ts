...
export function randomSequence(len:number, list:any) {
    if (len <= 1) { 
        len = 1; 
    }
    var s = "";
...
//对名字去重
const nameSet = (names:Array<string>) =>{
  let result = []
  let obj = {}
...
export function getRandomName () {
  ...
  let lastNames = new Array<string>(
...
//随机生成日期
export function getRandomDate(min?:any, max?:any) { // min, max
